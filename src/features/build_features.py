...
def _build_feature_dataframe(dataframe: pd.DataFrame) -> pd.DataFrame:
    ...
    pm25_series = dataframe["pm2_5"].astype(float)
    pm10_series = dataframe["pm10"].astype(float)
    no2_series = dataframe["no2"].astype(float)
    o3_series = dataframe["o3"].astype(float)
    ...
    dataframe["aqi_lag_168"] = aqi_series.shift(168)
    dataframe["pm2_5_lag_24"] = pm25_series.shift(24)
    dataframe["pm2_5_lag_168"] = pm25_series.shift(168)
    dataframe["pm10_lag_24"] = pm10_series.shift(24)
    dataframe["pm10_lag_168"] = pm10_series.shift(168)
    dataframe["aqi_delta_3h"] = aqi_series.diff(3)
    dataframe["aqi_delta_6h"] = aqi_series.diff(6)
    dataframe["aqi_delta_12h"] = aqi_series.diff(12)
    dataframe["pm2_5_delta_3h"] = pm25_series.diff(3)
    dataframe["pm2_5_delta_6h"] = pm25_series.diff(6)
    dataframe["pm2_5_delta_12h"] = pm25_series.diff(12)
    dataframe["pm10_delta_3h"] = pm10_series.diff(3)
    dataframe["pm10_delta_6h"] = pm10_series.diff(6)
    dataframe["no2_delta_3h"] = no2_series.diff(3)
    dataframe["o3_delta_3h"] = o3_series.diff(3)
    dataframe["aqi_rolling_24"] = aqi_series.rolling(window=24).mean()
    dataframe["aqi_rolling_min_24"] = aqi_series.rolling(window=24).min()
    dataframe["aqi_rolling_max_24"] = aqi_series.rolling(window=24).max()
    dataframe["aqi_rolling_std_24"] = aqi_series.rolling(window=24).std()
    dataframe["pm25_rolling_24"] = pm25_series.rolling(window=24).mean()
    dataframe["pm25_rolling_min_24"] = pm25_series.rolling(window=24).min()
    dataframe["pm25_rolling_max_24"] = pm25_series.rolling(window=24).max()
    dataframe["pm25_rolling_std_24"] = pm25_series.rolling(window=24).std()
    dataframe["pm10_rolling_24"] = pm10_series.rolling(window=24).mean()
    dataframe["pm10_rolling_min_24"] = pm10_series.rolling(window=24).min()
    dataframe["pm10_rolling_max_24"] = pm10_series.rolling(window=24).max()
    dataframe["pm10_rolling_std_24"] = pm10_series.rolling(window=24).std()
    dataframe["co_rolling_24"] = dataframe["co"].astype(float).rolling(window=24).mean()
