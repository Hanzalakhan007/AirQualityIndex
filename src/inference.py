...
def build_input_frame(latest_row: pd.Series, overrides: dict[str, float] | None = None) -> pd.DataFrame:
    ...
    frame = {
        ...
        "aqi_lag_168": float(overrides.get("aqi_lag_168", latest_row.get("aqi_lag_168", current_us_aqi))),
        "pm2_5_lag_24": float(overrides.get("pm2_5_lag_24", latest_row.get("pm2_5_lag_24", latest_row.get("pm2_5", 0.0)))),
        "pm2_5_lag_168": float(overrides.get("pm2_5_lag_168", latest_row.get("pm2_5_lag_168", latest_row.get("pm2_5", 0.0)))),
        "pm10_lag_24": float(overrides.get("pm10_lag_24", latest_row.get("pm10_lag_24", latest_row.get("pm10", 0.0)))),
        "pm10_lag_168": float(overrides.get("pm10_lag_168", latest_row.get("pm10_lag_168", latest_row.get("pm10", 0.0)))),
        "aqi_delta_3h": float(overrides.get("aqi_delta_3h", latest_row.get("aqi_delta_3h", 0.0))),
        "aqi_delta_6h": float(overrides.get("aqi_delta_6h", latest_row.get("aqi_delta_6h", 0.0))),
        "aqi_delta_12h": float(overrides.get("aqi_delta_12h", latest_row.get("aqi_delta_12h", 0.0))),
        "pm2_5_delta_3h": float(overrides.get("pm2_5_delta_3h", latest_row.get("pm2_5_delta_3h", 0.0))),
        "pm2_5_delta_6h": float(overrides.get("pm2_5_delta_6h", latest_row.get("pm2_5_delta_6h", 0.0))),
        "pm2_5_delta_12h": float(overrides.get("pm2_5_delta_12h", latest_row.get("pm2_5_delta_12h", 0.0))),
        "pm10_delta_3h": float(overrides.get("pm10_delta_3h", latest_row.get("pm10_delta_3h", 0.0))),
        "pm10_delta_6h": float(overrides.get("pm10_delta_6h", latest_row.get("pm10_delta_6h", 0.0))),
        "no2_delta_3h": float(overrides.get("no2_delta_3h", latest_row.get("no2_delta_3h", 0.0))),
        "o3_delta_3h": float(overrides.get("o3_delta_3h", latest_row.get("o3_delta_3h", 0.0))),
        "aqi_rolling_24": float(overrides.get("aqi_rolling_24", latest_row.get("aqi_rolling_24", current_us_aqi))),
        "aqi_rolling_min_24": float(overrides.get("aqi_rolling_min_24", latest_row.get("aqi_rolling_min_24", current_us_aqi))),
        "aqi_rolling_max_24": float(overrides.get("aqi_rolling_max_24", latest_row.get("aqi_rolling_max_24", current_us_aqi))),
        "aqi_rolling_std_24": float(overrides.get("aqi_rolling_std_24", latest_row.get("aqi_rolling_std_24", 0.0))),
        "pm25_rolling_24": float(overrides.get("pm25_rolling_24", latest_row.get("pm25_rolling_24", latest_row.get("pm2_5", 0.0)))),
        "pm25_rolling_min_24": float(overrides.get("pm25_rolling_min_24", latest_row.get("pm25_rolling_min_24", latest_row.get("pm2_5", 0.0)))),
        "pm25_rolling_max_24": float(overrides.get("pm25_rolling_max_24", latest_row.get("pm25_rolling_max_24", latest_row.get("pm2_5", 0.0)))),
        "pm25_rolling_std_24": float(overrides.get("pm25_rolling_std_24", latest_row.get("pm25_rolling_std_24", 0.0))),
        "pm10_rolling_24": float(overrides.get("pm10_rolling_24", latest_row.get("pm10_rolling_24", latest_row.get("pm10", 0.0)))),
        "pm10_rolling_min_24": float(overrides.get("pm10_rolling_min_24", latest_row.get("pm10_rolling_min_24", latest_row.get("pm10", 0.0)))),
        "pm10_rolling_max_24": float(overrides.get("pm10_rolling_max_24", latest_row.get("pm10_rolling_max_24", latest_row.get("pm10", 0.0)))),
        "pm10_rolling_std_24": float(overrides.get("pm10_rolling_std_24", latest_row.get("pm10_rolling_std_24", 0.0))),
